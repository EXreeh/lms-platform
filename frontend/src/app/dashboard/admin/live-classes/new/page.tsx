...
export default function AdminNewLiveClassPage() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      router.push(`/dashboard/admin/live-classes/${res.data.id}`);
    } catch (err) {
  ...
  return (
    <DashboardShell title="Schedule live class" description="Add a Zoom meeting for a batch." badge="Administrator">
      <div className="flex flex-col gap-8 lg:flex-row">
        ...
        <div className="min-w-0 flex-1 space-y-4">
          ...
          <div className="rounded-2xl border border-border bg-card p-6">
            <LiveClassForm values={form} onChange={setForm} batches={batches} showTeacherSelect showStartUrl />
